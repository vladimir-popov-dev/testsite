...
# МЕТОД СОЗДАНИЯ ФОРМ, СВЯЗАННЫХ С МОДЕЛЬЮ. СВЯЗЬ АВТОМАТИЧЕСКАЯ
class NewsForm(forms.ModelForm):
    class Meta:
        model = News
        # fields = '__all__' добавления всех полей без перечисления
...
# МЕТОД СОЗДАНИЯ ФОРМ, НЕСВЯЗАННЫХ С МОДЕЛЬЮ. СВЯЗЬ ДЕЛАЛАСЬ ВРУЧНУЮ
